package
{
	import com.david5.objects.AlgebraicSurface2;
	...
	public class MainAlgebraicSurface2 extends BasicView
	{
		protected var superficie:AlgebraicSurface2;
...
//	private var rustAsset:Class;
		...
		public function MainAlgebraicSurface2()
		{
			stage.frameRate = 60;
...
//			material.addMaterial(matB);
			...
			superficie = new AlgebraicSurface2(material,widthD, heightD, 20,20, c);
		...
		protected function keyEvent(event:KeyboardEvent):void		
		{
			if(event.keyCode == 32)
			{
				...
				var superficie2:AlgebraicSurface2 = new AlgebraicSurface2(material, widthD, heightD, 20,20, c);
